    ...
    def _shadow_ops():
        try:
            ...
            if cache_result["hit"] and cache_result["results"]:
                ...
                # Use similarity score directly from LangCache (0.0-1.0, where 1.0 = 100% similar)
                similarity_score = first_result.get("similarity", 0.0)
            ...
            # Log shadow data
            logger.info(f"📊 LOGGING SHADOW DATA: cache_hit={cache_result['hit']}, similarity={similarity_score}")
